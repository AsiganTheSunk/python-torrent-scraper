...
from torrentscraper.core.scraper_engine.webscrapers import kat_scraper_type_a as kata, torrent_funk_scraper as funk, \
    pirate_bay_scraper as tpb, nyaa_scraper as nyaa
...
# Import Custom Utils
from torrentscraper.core.scraper_engine.webscrapers.utils.uri_builder import UriBuilder
...
class ScraperEngine(object):
    ...
    def _normalize_magnet_entries(self, raw_data, websearch, webscraper):
        ...
        :param webscraper: this value, represents the webscrapers class being used
    ...
    def _gather_raw_data(self, websearch, webscraper):
        ...
        # response = loop.run_until_complete(self.dynamic_search(websearch, webscrapers))
    ...
    async def fetch(session, url):
        async with session.get(url) as response:
            try:
                ...
                print('Assertion Error Status Code Diferent from 200')
