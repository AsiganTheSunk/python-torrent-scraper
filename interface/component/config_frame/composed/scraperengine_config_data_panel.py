...
class ScraperEngineConfigDataPanel(Frame):
    ...
    def on_create(self):
        ...
        label = Label(label_frame1, text='Information Sources', background=self.main_theme)
        label.grid(row=0, column=0)

        inner_border_frame0 = Frame(label_frame1, width=250, height=2, background=self.highlight_theme)
        ...
        button_box = ButtonBox(self, 7, 0, self.cmmndCloseConfig, self.save_picks)
